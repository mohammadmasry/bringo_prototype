    ...
    <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-2">
          <span className="text-xs font-bold px-2.5 py-1 rounded-full" style={{ background: size.bg, color: size.text }}>
            {order.size}
          </span>
      ...
      <div className="bg-white border-b border-gray-100 px-6 pt-8 pb-5">
        <div className="max-w-lg mx-auto">
          ...
          <div className="flex items-end justify-between">
            ...
            <div className="text-right">
              <p className="text-2xl font-black text-green-600">{MOCK_ORDERS.length}</p>
